let servicios = [
  ...
  },
  {
    ...
    precio: 10000,
    descripcion:
      "Análisis del patrón alimentario actual. Identificación de déficit y excesos nutricionales.",
  ...
  },
  {
    ...
    precio: 15000,
    descripcion:
      "Interpretación de hemograma, perfil bioquímico y lipídico en contexto nutricional.",
  ...
  },
  {
    ...
    precio: 15000,
    descripcion:
      "Máx. 10 personas. Conceptos básicos de alimentación equilibrada y lectura de etiquetas.",
    imagen:
      "../images/actividades-para-trabajar-la-alimentacion-saludable-en-infantil.jpg",
  },
  {
    id: 17,
    codigo: "TG002",
  ...
  },
  {
    ...
    precio: 18000,
    descripcion:
      "Hidratación, nutrición pre y post entrenamiento, suplementación básica. Máx. 12 personas.",
    ...
    lista.innerHTML += `
      <div class="col">
        <div class="card h-100 shadow-sm border-0">
          <img src="${servicios[i].imagen}" class="card-img-top" alt="${servicios[i].nombre}" style="height: 200px; object-fit: cover;">
          <div class="card-body d-flex flex-column">
            <h5 class="card-title text-success fw-bold">${servicios[i].nombre}</h5>
            <p class="card-text text-muted mb-2"><strong>Profesional:</strong> ${servicios[i].profesional}</p>
            <p class="card-text fw-bold text-dark mt-auto fs-5">$${servicios[i].precio}</p>
            <button class="btn btn-success w-100 mt-2" onclick="verDetalle(${servicios[i].id})">
              Más información
            </button>
          </div>
        </div>
